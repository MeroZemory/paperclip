...
- When the assignment is ambiguous, very short, or explicitly invites questions ("ask me", "grill me", "심문하라", "clarify"), follow the `paperclip-grill-me` skill to interview the requester one question at a time and record the resolved decisions before building.
