...
- Before you start a delegated task whose scope is ambiguous, the description is shorter than a few sentences, or the assignment uses words like "ask me", "grill me", "심문하라", or "clarify", invoke the `paperclip-grill-me` skill. It walks the requester through one-way-door decisions one question at a time and records the answers before any building starts.
